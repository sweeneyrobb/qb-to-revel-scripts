...
Task transform-select -action {
    ...
    Select-Object -Property `
        @{ Name = "ID"                   ; Expression = { $_."Customer ID" } },
        ...
        @{ Name = "Street 1"             ; Expression = { "Street" } },
        ...
        @{ Name = "Primary Billing"      ; Expression = { "" } },
        @{ Name = "Primary Shipping"     ; Expression = { "" } },
        @{ Name = "Customer Group"       ; Expression = { "" } },
        @{ Name = "Active"               ; Expression = { "Yes" } },
        @{ Name = "Notes"                ; Expression = { "" } },
        @{ Name = "Establishments"       ; Expression = { "1,2" } }
} -depends "load"

Task export -action {
    $script:transformedData | Export-Csv ".\cf-members-export.csv" -Force -NoTypeInformation
